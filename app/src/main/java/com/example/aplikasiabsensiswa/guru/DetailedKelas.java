...
public class DetailedKelas extends AppCompatActivity {
    ...
    public void updateKelas(String jurusan, Integer kelas, String key, String banner){
        Kelas updatedKelas = new Kelas(jurusan, kelas, banner);
    ...
    public void deleteKelas(String key){
        new AlertDialog.Builder(DetailedKelas.this)
                ...
                .setMessage("Apa anda yakin menghapus kelas ini?")
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updateButton.setOnClickListener(v -> {
            ...
            updateKelas(inputedJurusan, Integer.parseInt(inputedKelas), intent.getStringExtra("kelasKey"), intent.getStringExtra("banner"));
